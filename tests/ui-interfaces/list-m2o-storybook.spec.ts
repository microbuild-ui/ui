/**
 * ListM2O Interface Storybook E2E Tests
 * 
 * Tests the @buildpad/ui-interfaces ListM2O component in isolation using Storybook.
 ...
 * 
 * Note: ListM2O renders a "Configuration Error" message in Storybook because
...
test.describe('ListM2O - Advanced', () => {
  ...
  test('ProductCategory: renders product category use case', async ({ page }) => {
    await goToStory(page, 'interfaces-listm2o--product-category');
