...
import { Switch, SwitchProps, Box, Text, useMantineTheme } from '@mantine/core';
...
export const Toggle: React.FC<ToggleProps> = ({
  ...
  const defaultIconOn = iconOn || <IconCheck size={12} stroke={3} />;
  const defaultIconOff = iconOff || <IconX size={12} stroke={3} />;
